...
(function() {
  ...
  $(document).ready(function() {
    var add_yaml_entry, draft_post, focus_to_type, fullscreen_mobile, handle_events, init, is_edit_page, is_iphone, keyboard_events, publish_post, save_post, set_save_button, show_shortcuts;
    ...
    add_yaml_entry = function() {
      ...
      return $(html).insertBefore($('.add-yaml-entry'));
    };
    handle_events = function() {
      ...
      if (is_edit_page()) {
        ...
        return $('.add-yaml-entry').click(add_yaml_entry);
      }
    };
